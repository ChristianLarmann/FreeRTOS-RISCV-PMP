 ...
 *                  long)!
 */
static void prepare_key(const unsigned char *key, size_t key_len,
 ...
 */
void hmac_sha3(const unsigned char *key, size_t key_len,
               const unsigned char *text, size_t text_len, unsigned char *hmac)
{
    hmac_sha3_ctx_t ctx;
