...
(
  ...
  generate
    if (SECURE) begin : secure
      ...
      assign gntpar_err = 0; // CL: Changed (m_c_obi_data_if.s_gnt.gnt == m_c_obi_data_if.s_gnt.gntpar);
      ...
      assign rvalidpar_err_resp = 0; // CL: Changed | (m_c_obi_data_if.s_rvalid.rvalid == m_c_obi_data_if.s_rvalid.rvalidpar);
