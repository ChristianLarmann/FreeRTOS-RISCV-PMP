module UA_encrypt_hash_S
    ...
    reg                             cry_enc_dec;
    wire    [DATA_WIDTH-1:0]        cry_din_test;
    wire                            cry_enc_dec_test;
    // Output when done
    reg                             ready;
    ...
    begin        
        ...
        //  HASH VERIFICATION STATE==================================================================
            VHASH: begin
                // When calculated hash is identical to stored hash, go decrypt
    ...
    assign cry_din_test = (state == ENCRYPT ? wdata : (state == DECRYPT ? rdata: 0));
    assign cry_enc_dec_test = (state == ENCRYPT);
