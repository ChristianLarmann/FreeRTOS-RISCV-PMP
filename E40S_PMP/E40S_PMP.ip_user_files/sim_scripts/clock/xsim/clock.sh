...
#
# Script generated by Vivado on Tue Feb 20 15:03:50 CET 2024
...
# script info
echo -e "clock.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clock xil_defaultlib.clock xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clock -key {Behavioral:sim_1:Functional:clock} -tclbatch cmd.tcl -protoinst "protoinst_files/clock.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/christian/Apps/Xilinx/Vivado/2023.1/data/xsim"
  fi
