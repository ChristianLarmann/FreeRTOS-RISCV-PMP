...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ clock_clk_wiz_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clock_clk_wiz_0_0_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clock_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clock_clk_wiz_0_0_clk_wiz is
  signal clk_in1_clock_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_clock_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_clock_clk_wiz_0_0_en_clk : STD_LOGIC;
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_out1_clock_clk_wiz_0_0_en_clk
    );
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_clock_clk_wiz_0_0_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg1(0)
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clock_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
