...
# Setting unused ports to a safe default I/O standard and declaring them as unused
set_property IOSTANDARD LVCMOS33 [get_ports {output_LEDS[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {output_LEDS[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports BT_CTS]
set_property IOSTANDARD LVCMOS33 [get_ports BT_RTS]
...
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports {output_LEDS[0]}]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {output_LEDS[1]}]
set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports {output_LEDS[2]}]
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports {output_LEDS[3]}]
